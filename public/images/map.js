...
function createMap(currentHost){
    ...
    posSanCarlos = new google.maps.LatLng(-34.791832, -54.912436);
    ...
    var marker_image = new google.maps.MarkerImage(currentHost + 'img/pin.svg', new google.maps.Size(40, 54), new google.maps.Point(0,0));
